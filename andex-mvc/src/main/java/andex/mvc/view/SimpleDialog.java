...
public class SimpleDialog {
    ...
    public void showProgressDialog(String msg) {
        ...
        TextView textView = progressView.findViewById(R.id.axpd_msg);
    ...
    public AlertDialog showInputDialog(String title, String msg, int inputType, Object inputInit, final DialogCallback callback) {
        ...
        final EditText etInput = inputView.findViewById(R.id.et_single_input);
        Builder dBuilder = new Builder(context);
    ...
    public AlertDialog showRadioGroupDialog(String title, String msg, String[] labels, int checked,
        ...
        final RadioGroup radioGroup = inputView.findViewById(R.id.cdr_rg_selection);
     ...
     *
     * @param title
     * @param checkboxListViewAdapter Adapter to init the list view with checkboxes.
    ...
    public AlertDialog showCheckBoxesDialog(String title, BaseAdapter checkboxListViewAdapter,
        ...
        final ListView listView = inputView.findViewById(R.id.cdl_list);
    ...
    public void showListSelectDialog(final String title, final Map items, final DialogCallback callback) {
        ...
        ListView listSelect = layout.findViewById(R.id.cdl_list);
    ...
    public static class CustomDialogInit {
         ...
         * @return size of data
         */
        public int init(View layout, int resId) {
            return 0;
        }

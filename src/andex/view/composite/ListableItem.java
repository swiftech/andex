...
public class ListableItem extends HashMap<String, Object> {
	...
	public ListableItem(int id, String title) {
		put(KEY_ID, id);
		put(KEY_TITLE, title);
		put(KEY_ITEM_TYPE, 0);
	}

	public ListableItem(int id, String title, String desc) {
		put(KEY_ID, id);
		put(KEY_TITLE, title);
		put(KEY_DESC, desc);
		put(KEY_ITEM_TYPE, 0);
	...
	public ListableItem(int id, String title, int itemType) {
		put(KEY_ID, id);
		put(KEY_TITLE, title);
	 ...
	 */
	public ListableItem(int id, String title, String desc, int itemType) {
		put(KEY_ID, id);
		put(KEY_TITLE, title);
		put(KEY_DESC, desc);
		put(KEY_ITEM_TYPE, itemType);
